...
** Studies
#+begin_src elisp
  (let ((org-path (concat user-emacs-directory "study/")))
  ...
  (use-package org-roam
    :ensure t
    :defer t
    :bind (("C-c m r" . org-roam-node-find)
    	 ("C-c m i" . org-roam-node-insert))
    :custom
    (org-roam-directory (concat user-emacs-directory "study/"))
    :config
